...
class Homework {
    constructor() {
        ...
        this.source$ = rxjs_1.fromEvent($('.live-search'), 'keyup')
            .pipe(operators_1.map((ev) => {
            return ev.target.value;
        }));
    }
    getDataFromGit(search) {
        getData(search);
        return search;
    }
}
...
], Homework.prototype, "getDataFromGit", null);
exports.Homework = Homework;
const myClass = new Homework;
// ----------------------------------------------------------------------------------------------
/** получение данных*/
myClass.stream$$.subscribe((data) => {
    console.log(data);
    $('.list li').remove();
    data.forEach((item) => {
...
myClass.source$.subscribe((val) => {
    myClass.getDataFromGit(val);
});
// ----------------------------------------------------------------------------------------------
// отложенный запуск поиска
function debounce(ms) {
    return (target, _methodName, descriptor) => {
        ...
        return Object.assign({}, descriptor, { value: decorated });
    };
}
// ----------------------------------------------------------------------------------------------
